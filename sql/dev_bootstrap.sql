-- ============================================================================
-- Dolos — LOCAL development bootstrap.
-- Creates the database (if missing) then all tables + seed data.
--   mysql -h 127.0.0.1 -P 8889 -u root -proot < sql/dev_bootstrap.sql
-- On the production host, use sql/production.sql instead (DB already exists).
-- ============================================================================

CREATE DATABASE IF NOT EXISTS `crossp11_db1`
...
CREATE TABLE IF NOT EXISTS `dolos_orders` (
  ...
  `attending_adults`        INT          NOT NULL DEFAULT 0,
